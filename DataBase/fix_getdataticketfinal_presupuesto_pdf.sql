-- =====================================================================
-- FIX: getdataticketfinal() - pdf_path_presupuesto desde archivos_adjuntos
-- Problema: el PDF del presupuesto se guardaba en archivos_adjuntos con
-- document_type = 'presupuesto', pero la función solo buscaba en budgets.pdf_path.
-- Solución: agregar un LEFT JOIN LATERAL a archivos_adjuntos para presupuesto
-- y usar COALESCE(bg.pdf_path, adj_presupuesto.file_path) como pdf_path_presupuesto.
-- =====================================================================
...
BEGIN
    ...
    -- FIX: JOIN para obtener el PDF del presupuesto desde archivos_adjuntos
    LEFT JOIN LATERAL (
        SELECT 
            adj.file_path
        FROM archivos_adjuntos adj
