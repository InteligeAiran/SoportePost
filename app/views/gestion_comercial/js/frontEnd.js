...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("confirmGenerateConvenioBtn")
    .addEventListener("click", function () {
      ...
      console.log("Ticket ID obtenido:", ticketId);
        ...
        Swal.fire({
                ...
                text: `Generando convenio firmado: ${convenioNumero}`,
                icon: "info",
        ...
        setTimeout(() => {
            Swal.fire({
                  ...
                  text: `El convenio firmado ${convenioNumero} ha sido generado exitosamente.`,
                  icon: "success",
...
function showUploadDocumentModal() {
  // Obtener el ticketId del modal de generar convenio
  const ticketId = document.getElementById("generate_id_ticket").value;
  
  // Obtener el número de ticket para mostrar en el modal
...
$(document).ready(function () {
  const changeStatusDomiciliacionModalElement = document.getElementById(
    ...
    $(document).on('click', '.adjuntar-documento-btn', function () {
        ...
        // Configurar el modal de subir documento
        document.getElementById('modalTicketId').textContent = nroTicket || idTicket;
        document.getElementById('id_ticket').value = idTicket;
        document.getElementById('type_document').value = 'convenio_firmado';
...
if (printBtn) {
    ...
    printBtn.addEventListener("click", function () {
      ...
      if (
        ...
        // Usar el valor del campo del formulario en lugar de la variable global
        const convenioNumero = document.getElementById("pa_numero_ticket").value;
        ...
        <div class="container">
            ...
            <div class="document-info">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">${convenioNumero || safe(d.nro_ticket)}</div>
                    
                    <script>
                        console.log("=== DEBUG BUILD HTML ===");
                        console.log("convenioNumero:", "${convenioNumero}");
                        console.log("d.nro_ticket:", "${safe(d.nro_ticket)}");
                        console.log("Valor final:", "${convenioNumero || safe(d.nro_ticket)}");
                    </script>
