    ...
    <div class="modal fade" id="modalPagoPresupuesto" tabindex="-1" aria-labelledby="modalPagoPresupuestoLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow-lg border-0" style="border-radius: 12px;">
                <div class="modal-header bg-gradient-success text-white" style="border-radius: 12px 12px 0 0;">
                    <h5 class="modal-title" id="modalPagoPresupuestoLabel">
                        <i class="bi bi-cash-coin me-2"></i>Pago de Presupuesto
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form id="formPagoPresupuesto">
                        <!-- Información del Ticket y Presupuesto -->
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label for="pagoPresupuestoTicket" class="form-label fw-bold text-secondary">Nro. Ticket</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light" style="height: 41px;"><i class="bi bi-ticket-perforated"></i></span>
                                    <input type="text" class="form-control bg-light" id="pagoPresupuestoTicket" readonly>
                                </div>
                            </div>
                            <!-- Aquí podrías agregar el Nro de Presupuesto si lo tuvieras disponible -->
                             <div class="col-md-6">
                                <label class="form-label fw-bold text-secondary">&nbsp;</label> <!-- Spacer -->
                                <button type="button" class="btn btn-outline-primary w-100" id="btnVisualizarPresupuestoModal">
                                    <i class="bi bi-eye me-2"></i>Visualizar Presupuesto
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check form-check-inline custom-radio-lg">
                                        <input class="form-check-input" type="radio" name="metodoPagoPresupuesto" id="metodoPagoBs" value="bs" checked>
                                        <label class="form-check-label" for="metodoPagoBs">
                                            <i class="bi bi-currency-exchange me-1 text-success"></i>Bolívares (Bs)
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline custom-radio-lg">
                                        <input class="form-check-input" type="radio" name="metodoPagoPresupuesto" id="metodoPagoUsd" value="usd">
                                        <label class="form-check-label" for="metodoPagoUsd">
                                            <i class="bi bi-currency-dollar me-1 text-primary"></i>Dólares (USD)
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                             <div class="col-md-6">
                                <label for="montoPagoPresupuesto" class="form-label fw-bold">Monto <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text" id="monedaSimbolo">Bs</span>
                                    <input type="number" step="0.01" class="form-control" id="montoPagoPresupuesto" placeholder="0.00" required>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <label for="referenciaPagoPresupuesto" class="form-label fw-bold">Referencia / Comprobante <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text" style="height: 41px;"><i class="bi bi-hash"></i></span>
                                    <input type="text" class="form-control" id="referenciaPagoPresupuesto" placeholder="Ej: 12345678" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                 <label for="bancoPagoPresupuesto" class="form-label fw-bold">Banco / Plataforma <span class="text-danger">*</span></label>
                                 <select class="form-select" id="bancoPagoPresupuesto" required>
                                     <option value="">Seleccione...</option>
                                     <!-- Se llenará dinámicamente o estáticamente según requerimiento -->
                ...
                <div class="modal-footer bg-light" style="border-radius: 0 0 12px 12px;">
                    <button type="button" id="btnCerrarPagoPresupuesto" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-success px-4" id="btnGuardarPagoPresupuesto">
