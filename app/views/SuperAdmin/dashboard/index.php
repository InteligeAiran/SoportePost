...
<lang="en">
    <head>
        ...
        <!-- DataTables -->
        <link  rel="stylesheet" href="<?php echo APP;?>app/plugins/datatables/datatables.css" />
        <link  rel="stylesheet" href="<?php echo APP;?>app/plugins/datatables/datatables.min.css" />
    ...
    <body class="g-sidenav-show   bg-gray-100">
        ...
        <!-- NAVBAR -->
        <?php require_once 'app/core/components/navbar_SA.php'; mi_navbar(); ?>
        <!-- CIERRE NAVBAR -->
                        ...
                        <div class="card ">
                            <div class="card-header pb-0 p-3">
                                <div class="d-flex justify-content-between">
                                    <h6 style = "margin-left: 340px;" class="mb-2"><stong>Usuarios Registrados</h6></stong>
                                </div><br>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center justify-content-lg-between">
                            <div class="col-lg-6 mb-lg-0 mb-4">
                                <div  style="margin-top: 80px;" class="copyright text-center text-sm text-muted text-lg-start">
                                    © <script>
