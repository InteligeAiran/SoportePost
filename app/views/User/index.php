...
<!DOCTYPE html>
    ...
    <body id="fondo" class="g-sidenav-show bg-gray-100">
        ...
        <!-- MODAL PARA SELECCIONAR TECNICO -->
            <div class="modal fade" id="ModalAggUsers" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="apellidouser" class="form-control" name="apellidouser"
                                        onkeypress="return soloLetras(event)" onchange="nameUsuario()">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group" style="width: 92%;">
                                        <input name="tipodoc" id="tipodoc" type="text" value="V-" class="form-control"
                                            disabled>
                                        <span class="input-group-addon"></span>
                                        <input style="width: 70%;" class="form-control" type="text" name="documento"
                                            id="documento" maxlength="9" onkeypress="return soloNumeros(event)">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="usuario">Usuario:</label>
                                    <input type="text" id="usuario" class="form-control" name="usuario" disabled
                                        onchange="nameUsuario()">
                                </div>
                            </div>
