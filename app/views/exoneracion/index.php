                            ...
                            <div class="form-section">
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="date" class="form-control" id="fechaPago" placeholder="dd/mm/aaaa" required style="font-size: 0.95rem; padding: 8px 12px;" onchange="loadExchangeRateToday(this.value);">
                                    </div>
                                    <div class="col-md-6 mb-2">
