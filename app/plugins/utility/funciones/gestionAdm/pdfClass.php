  ...
  function Footer1($valPie)
     {
      ...
      $txt_14 ='Centro Sim�n Bol�var, Edificio Sur, Ministerio del Poder Popular para la Salud, piso 3, oficina 313,';
      $txt_15 ='Servicio Aut�nomo de Contralor�a Sanitaria';
      $txt_16 ='Tel�fono 4080477 Telefax 4080505 P�gina web: http://sacs.mpps.gob.ve'; 
   ...
   function writePermiso($arrDatos){
    ...
    //Razon Social 
          //$this->MultiCell('170','6','Raz�n Social:','0','J',false);   
    ...
    //Representante Legal 
      ...
      //Separacion par el texto 
          $this->Ln(3);
      //Texto 1 
         $txt_1 = '     En respuesta a su solicitud N� '.$arrDatos['nroSol'].' de fecha: '.$arrDatos['fecha'];
         $txt_1.= ' en la cual pide el Permiso Sanitario correspondiente al establecimiento '.$arrDatos['uso'];
         $txt_1.= ', construido en un �rea de: '.$arrDatos['dimension'].', ubicado en: '.$arrDatos['direccion'].', ';
         $txt_1.= 'Parroquia: '.$arrDatos['parroquia'].', cumplo con informarle que basados en el principio de buena fe ';
         $txt_1.= 'por parte del interesado y de acuerdo a lo establecido en los art�culos 83 y 84 de la CONSTITUCI�N DE LA REP�BLICA ';
         $txt_1.= 'BOLIVARIANA DE VENEZUELA. Ley Org�nica de Salud, Art. 32-33 del Reglamento General de Alimentos y sus Normas Complementarias, '; 
         $txt_1.= 'el Servicio Aut�nomo de Contralor�a Sanitaria (SACS) considera APROBARLO.';
      ...
      //Texto 2
        ...
        $txt_2.='del Poder Popular para la Salud a trav�s del Servicio Aut�nomo de Contralor�a Sanitaria, ';
     ...
     //Texto 3
        $this->Ln(5);
        $txt_3 = 'En caso de no permitir la inspecci�n correspondiente, suministrar infomaci�n falsa o deterioro de las condiciones higi�nicas sanitarias, ';
        $txt_3.= 'as� como modificaciones de cualquier tipo, sin previa consulta y aprobaci�n por parte del SACS, posterior a su otorgamiento, nos reservamos el derecho ';
        $txt_3.= 'a ejercer las acciones administrativas y legales pertinentes.';
        $this->MultiCell('170','6',$txt_3,'0','J',false); 
     //Vigencia   
        $txt_4 ='ESTE PERMISO TIENE UNA VIGENCIA DE UN (1) A�O'; 
     ...
     //***Texto5
       ...
       $txt_11 ='Firmado Digitalmente por '.utf8_decode($arrDatos["char_nombre"]).', para verificar la valid�z de este permiso puede ingresar a la p�gina Web http://www.sacs.gob.ve, secci�n "CONSULTAS" y seleccionar "Permisos Estadales".'; 
    ...
    function writeVehiculo($arrDatos){
      ...
      //Datos del Permiso
           $this->SetFont('Arial','','12');
           $encab = $arrDatos["contraloria"];
           $tit_1 ='PERMISO SANITARIO PARA VEH�CULOS '.$arrDatos["idTag"];
           $tit_2 = 'PSN� '.$arrDatos["permiso"];
           $this->Ln(20);
           $this->MultiCell('170','6',$encab,'0','C',false);
           $this->MultiCell('170','6',$tit_1,'0','C',false);
      ...
      //Establecimiento
          $this->Ln(8);
          //$this->MultiCell('170','6','Veh�culo: ','0','J',false);
    ...
    //Representante Legal 
      ...
      //Texto 1 
         ...
         $txt_1.= ', con las siguientes caracter�sticas: Placa: '.$arrDatos['placa'].', Marca: '.$arrDatos['marca'].', Modelo: '.$arrDatos['modelo'].', ';
         $txt_1.= 'Serial de Carrocer�a: '.$arrDatos['carroceria'].', Serial de Motor: '.$arrDatos['motor'].', Color: '.$arrDatos['color'].', Rubro: '.$arrDatos['rubro'];
   ...
   function writeRegulacion($arrDatos){
    ...
    //Razon Social 
          ...
          //$this->MultiCell('170','6',$arrDatos['razon'],'0','J',false);  
    //Representante Legal 
          $this->MultiCell('170','6','Director M�dico o Propietario:','0','J',false);   
          $this->MultiCell('170','6',$arrDatos['Prop'],'0','J',false);           
          //$this->MultiCell('170','6','Propietario : '.$arrDatos['propietario'].'-'.$arrDatos['cedprop'],'0','J',false);   
          //$this->MultiCell('170','6',$arrDatos['repre'].'        '.$arrDatos['cedula'],'0','J',false);           
          $this->MultiCell('170','6','Presente.-','0','J',false);
      ...
      //Texto 1 
         $txt_1 = '     En respuesta a su solicitud N� '.$arrDatos['nroSol'].' de fecha: '.$arrDatos['fecha'];
         $txt_1.= ' en la cual pide el Permiso Sanitario correspondiente al establecimiento '.$arrDatos['uso'];
         $txt_1.= ', se le notifica que el Servicio Aut�nomo de Contralor�a Sanitaria una vez verificado el cumplimiento de los requisitos exigidos, '; 
         $txt_1.= 'se le otorga el PERMISO SANITARIO para su instalaci�n y funcionamiento bajo la denominaci�n suscrita seg�n Registro Mercantil de "'.$arrDatos['estab'].'", ';
         ...
         if ($arrDatos['contraloria'] === 'NIVEL CENTRAL') {
           $txt_1.= 'Seg�n proyecto aprobado bajo oficio N� '.$arrDatos['ofi'].' de fecha '.$arrDatos['fechOfi'].'. ';
         }
         $txt_1.= 'Cumpliendo as� con lo establecido en la Ley Org�nica de Salud N� 36.579 de fecha 11 de Noviembre de 1998 y la Gaceta Oficial de la Rep�blica Bolivariana de Venezuela N� 36.595 del 03 de Diciembre de 1998.';
     ...
     //Texto 3
        ...
        $this->MultiCell('170','6',$txt_3,'0','J',false); 
     //Vigencia   
        $txt_4 ='ESTE PERMISO TIENE UNA VIGENCIA DE DOS (2) A�OS'; 
        $this->MultiCell('170','6',$txt_4,'0','J',false); 
     //Texto 4 Firma Electronica
       $this->Ln(17);
       $numLinFirma=(int)$this->GetY();
    ...
    //###FIN###
      ...
      //Datos del Permiso
        ...
        //$encab = $arrDatos["contraloria"];
        $encab = $arrDatos["contraloria"];
        $tit_1 ='ACTA DE INSPECCION HIGI�NICO-SANITARIA';
        $tit_2 = 'INSPECCI�N N� '.$arrDatos["nro_acta"].' - SOL. N�. '.$arrDatos['nroSol'];
        $this->Ln(20);
        $this->MultiCell('170','6',$encab,'0','C',false);
        $this->MultiCell('170','6',$tit_1,'0','C',false);
        $this->MultiCell('170','6',$tit_2,'0','C',false);
      ...
      //Texto 1 
         switch ($arrDatos['area']) {
            case 1:
              $txt_1 = '  En la Ciudad de:_____________, a los____ d�as, del mes de__________, de _____, ';
              $txt_1.= 'siguiendo instrucciones del Servicio Aut�nomo de Contralor�a Sanitaria, se presentaron ';
              $txt_1.= 'los siguientes funcionarios quienes suscriben la siguiente acta:';  
            break;
            case 2:
              $txt_1 = '  En la Ciudad de_____________, a los__________(   ) d�as del mes de__________del a�o__________, ';
              $txt_1.= 'siguiendo instrucciones del Servicio Aut�nomo de Contralor�a Sanitaria, bajo la autorizaci�n N�__________de fecha__________, ';
      ...
      //Cuadro para funcionarios 
         switch ($arrDatos['area']) {
           ...
           case 2:
            ...
            $this->SetAligns(array('C','C','C'));
            $this->Row(array('NOMBRE','CEDULA DE IDENTIDAD','DIRECCI�N ADMINISTRATIVA'));
            for($i=0;$i<5;$i++){
             $this->Row(array('','',''));      
            }
           break;
      ...
      switch ($arrDatos['area']) {
        ...
        $this->Row(array('Raz�n Social:',$arrDatos['estab'])); 
        $this->Row(array('Rif:',$arrDatos['rif'])); 
        $this->Row(array('Ubicaci�n:',$arrDatos['direccion'])); 
        ...
        $this->Row(array('Tel�fono:',$arrDatos['telefono'])); 
        ...
        $txt_3 = "Fu�mos atendidos por el ciudadano(a):_________________________________, ";
        $txt_3.= "portador de la c�dula de identidad N�________________, que ocupa el cargo ";
        $txt_3.= "de:_____________________, con el objeto de realizar Inpsecci�n Higi�nico-Sanitaria ";
        ...
        $this->SetAligns(array('C','C','C')); 
        $this->Row(array('DESCRIPCI�N:','SI','NO'));    
        $this->SetAligns(array('L','C','C'));
        $this->Row(array('Registro Mercantil','',''));    
        $this->Row(array('Registro de Informaci�n Fiscal N�','',''));    
        ...
        $this->Row(array('RAZ�N SOCIAL DEL ESTABLECIMIENTO:','N� DE RIF:'));
        ...
        $this->MultiCell('170',6,'CLASIFICACI�N DEL ESTABLECIMIENTO SEG�N LA SOLICITUD',1,'C',false); 
        $this->SetWidths(array(85,85));
        $this->SetAligns(array('',''));
        $this->Row(array($arrDatos['tipoSol'],$arrDatos['uso']));
        $this->Ln(5);
        $this->MultiCell('170',6,'DATOS DEL DIRECTOR M�DICO',1,'C',false);
        ...
        $this->SetAligns(array('','',''));
        $this->Row(array('MATRICULA DEL M.S.:','PROFESI�N:','TEL�FONOS:'));
        $this->Row(array('','',''));
        $this->Ln(5);
      ...
      //Separacion par el texto 
        switch ($arrDatos['area']) {
          case 1:
            ...
            $this->MultiCell('170',6,'PARA EL �REA DE ALIMENTOS',1,'C',false); 
            $this->SetWidths(array(140,15,15));
            $this->SetAligns(array('C','C','C')); 
            $this->Row(array('DESCRIPCI�N:','SI','NO'));    
            $this->SetAligns(array('L','C','C'));
            $this->Row(array('Permisos Sanitario de Establecimiento de Alimentos','',''));    
            $this->Row(array('Certificados del Curso de Manipulaci�n de Alimentos del Personal que labora en la empresa. Requerido:         , Presentado:         , Faltante:       ','',''));    
            $this->Row(array('Registro de Control de Plagas, Insectos y Roedores y Certificado de �ltima fumigaci�n.','',''));
          break;
          case 2:
       ...
       //Firma Funcionarios y Administrados 
        ...
        switch ($arrDatos['area']) {
          case 1:
            ...
            $this->SetAligns(array('C','C','C')); 
            $this->Row(array('Funcionarios del SACS-MPPS','C�dula','Firma'));    
            for($i=0;$i<4;$i++){
             $this->Row(array('','',''));      
            }
            $this->SetAligns(array('C','C','C')); 
            $this->Row(array('Representante(s) del Establecimiento','C�dula','Firma'));    
            for($i=0;$i<4;$i++){
             $this->Row(array('','',''));      
            }
          break;
      ...
      //Datos del Permiso
        ...
        switch ($arrDatos['area']) {
          ...
          if($arrDatos["tipoSol"] == 5 || $arrDatos["tipoSol"] == 19 ){
           $this->Row(array('Propietario/Rep. Legal del Veh�culo','C�dula','Firma'));       
          }else{
           $this->Row(array('Representante(s) del Establecimiento','C�dula','Firma'));    
          } 
   ...
   //Emision del Acta de Inpseccion
    function writeActaVeh($arrDatos){
      ...
      //Cuadro con los Datos del Establecimiento
        $this->Ln(5);
        $txt_2.= 'Al veh�culo identificado con los siguientes datos:';
        $this->MultiCell('170','6',$txt_2,'0','J',false);         
        $this->Ln(3);
        $this->MultiCell('170',6,'DATOS DEL VEH�CULO',1,'C',false); 
        $this->SetWidths(array(40,130));
        $this->SetAligns(array('L','L'));
        $this->Row(array('Estado:',$arrDatos['estado'])); 
        $this->Row(array('Municipio:',$arrDatos['municipio'])); 
        ...
        $this->Row(array('Serial Carrocer�a:',$arrDatos['carroceria'])); 
        $this->Row(array('Sistema de Enfriamiento:',$arrDatos['enfria'])); 
        $this->Row(array('Descripci�n Sist.:',$arrDatos['enfria_des'])); 
        $this->Row(array('Rubro:',$arrDatos['rubro']));
        $this->Row(array('Tel�fono Contacto:',$arrDatos['telefono'])); 
      //Datos de la persona que recibe a los insp.
        $txt_3 = "Fu�mos atendidos por el ciudadano(a):_________________________________, ";
        $txt_3.= "portador de la c�dula de identidad N�________________, que ocupa el cargo ";
        $txt_3.= "de:_____________________, con el objeto de realizar Inpsecci�n Higi�nico-Sanitaria ";
        $txt_3.= "al Veh�culo anteriormente identificado a modo de constatar el cumplimiento "; 
        $txt_3.= "de la Normativa Sanitaria Vigente, por lo que se procede a revisar la existencia de ";
        $txt_3.= "los siguientes documentos:";
        $this->Ln(3);
        $this->MultiCell('170','6',$txt_3,'0','J',false);         
