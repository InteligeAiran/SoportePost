  ...
  function Footer1($valPie)
     {
      ...
      $txt_15 ='Servicio Aut�nomo de Contralor�a Sanitaria - Direcci�n de Higiene de los Alimentos';
   ...
   function writeSol($arrDatos){
      ...
      //Datos del Permiso
        ...
        //Datos de la Solicitud 
          ...
          $this->Row(array('Tipo de Tr�mite:',$arrDatos['idTag'])); 
          $this->Row(array('�rea:',$arrDatos['area'])); 
          $this->Row(array('Tipo de Solicitud:',$arrDatos['tipoSol'])); 
          $this->Row(array('Categor�a:',$arrDatos['categoria'])); 
     ...
     function writeEstab($arrDatos){
      //Datos del Establecimiento 
          ...
          $this->Row(array('Tel�fono Principal:',$arrDatos['telefono1'])); 
          $this->Row(array('Tel�fono Secundario:',$arrDatos['telefono2'])); 
    ...
    function writeProp($arrDatos){
      //Datos del Establecimiento 
          ...
          if($valNac == 1 || $valNac == 2){
            ...
            $this->Row(array('C�dula:',$arrDatos['cedula'])); 
            $this->Row(array('Nombre(s):',$arrDatos['nombres'])); 
            $this->Row(array('Apellido(s):',$arrDatos['apellidos'])); 
            $this->Row(array('Tel�fono Principal:',$arrDatos['tel_fijo'])); 
            $this->Row(array('Correo Electr�nico:',$arrDatos['correo']));
          }else{
            $this->Row(array('Rif:',$arrDatos['cedula'])); 
            $this->Row(array('Raz�n Social:',$arrDatos['nombres'])); 
            $this->Row(array('Tel�fono Principal:',$arrDatos['tel_fijo'])); 
            $this->Row(array('Correo Electr�nico:',$arrDatos['correo']));
          } 
     }     
   ...
   //Emision del Acta de Inpseccion
    function writeVehiculo($arrDatos){
        //Datos del Vehiculo 
          ...
          $this->Row(array('Descripci�n Sist.:',$arrDatos['descEnfria'])); 
          $this->Row(array('Rubro(s):',$arrDatos['rubro'])); 
     }  
