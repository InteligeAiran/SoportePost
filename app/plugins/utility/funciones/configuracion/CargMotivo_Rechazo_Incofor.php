<?php
//Función()
function CargMotivo_Rechazo_Incofor(){
 ...
 $sql="SELECT * FROM tipo_rechazo WHERE n_tipo_rechazo = '1' ORDER BY id_tipo_rechazo ASC";
...
$xajax->registerFunction("CargMotivo_Rechazo_Incofor");
