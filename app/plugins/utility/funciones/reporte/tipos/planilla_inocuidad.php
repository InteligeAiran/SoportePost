 ...
 */
  class PlanInocuidad extends FPDF{
     ...
     var $aligns;
      ...
      //Datos de las Empresas
        public function writeEmpresa($arrEmpre){
           ...
           $this->Row(array('Raz�n Social de la Empresa','Actividad','Rif/Id'));  
           $this->SetFont('Arial','','10');
        ...
        //Datos del Producto
           ...
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'DATOS DE IDENTIFICACI�N DEL PRODUCTO',1,'L',false); 
           $this->SetWidths(array(70,60,60));
           $this->SetFont('Arial','B','10');
           $this->SetAligns(array('L','L','C'));
           $this->Row(array('Denominaci�n','Nombre de Fantas�a','Marca'));  
           $this->SetFont('Arial','','10');
          ...
          public function writeEnvase($arrEnvase){
               ...
               $this->SetFont('Arial','B','10');
               $this->SetAligns(array('C','C','C','C'));
               $this->Row(array('Descripci�n','N� Autorizaci�n','Fecha','Uso del Envase y/o Empaque'));
               $this->SetFont('Arial','','10');
         ...
         //Presentacion y Contenido Neto
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'PRESENTACI�N Y CONTENIDO NETO',1,'L',false); 
       ...
       public function writeComp($arrCont){
        ...
        //Datos de la Composicion del Producto 
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'DATOS DE LA COMPOSICI�N DEL PRODUCTO',1,'L',false); 
    ...
    public function writeDuracion($arrCont){
        ...
        //Datos de la Composicion del Producto 
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'DATOS DE LA CONSERVACI�N Y DURACI�N DEL PRODUCTO',1,'L',false); 
           $this->SetWidths(array(110,30,50));
           $this->SetFont('Arial','B','10');
           $this->SetAligns(array('L','C','C'));
           $this->Row(array('Condiciones de la Conservaci�n','Cantidad','Tiempo(d�as,meses,a�os)'));
           //$this->MultiCell('190',6,$arrCont,1,'L',false); 
           $this->SetFont('Arial','','10');
     ...
     public function writeLote($arrCont){
        ...
        //Datos de la Composicion del Producto 
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'IDENTIFICACI�N DEL LOTE DE PRODUCCI�N',1,'L',false); 
           $this->SetWidths(array(80,110));
           $this->SetFont('Arial','B','10');
           $this->SetAligns(array('L','L'));
           $this->Row(array('C�digo del Lote','Descripci�n del Lote'));
           //$this->MultiCell('190',6,$arrCont,1,'L',false); 
           $this->SetFont('Arial','','10');
    ...
    public function writeObserva($observa){
        ...
        //Datos de la Composicion del Producto 
           $this->SetFont('Arial','B','10');
           $this->MultiCell('190',6,'OBSERVACI�N DEL SOLICITANTE',1,'L',false); 
           $this->SetFont('Arial','','10');
    ...
    public function writeSolicitante($data){
        ...
        //Datos de la Composicion del Producto
          //Datos de la Composicion del Producto 
             $this->SetFont('Arial','B','10');
             $this->MultiCell('190',6,'INFORMACI�N DEL SOLICITANTE',1,'C',false); 
             $this->SetWidths(array(20,55,50,35,30));
             $this->SetFont('Arial','','10');
             $this->SetAligns(array('C','C','C','C','C'));
             $this->Row(array('Cedula','Nombre y Apellido','Correo Electr�nico','Tel�fono','Firma Solicitante'));
     ...
     //***** NOTIFICACIONES******/////
        ...
        public function writeAjusteGrado($data){
           ...
           //Datos de la Composicion del Producto 
             ...
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C','C'));
             $this->Row(array('Grado Anterior','Grado Solicitado','Denominaci�n despu�s del Cambio'));
        ...
        public function writeCmbIngre($data){
           ...
           //Datos de la Composicion del Producto 
             $this->SetFont('Arial','B','10');
             $this->MultiCell('190',6,'INFORMACI�N DEL CAMBIO SOLICITADO',1,'L',false); 
             $this->SetWidths(array(40,40,80,30));
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C','C','C'));
             $this->Row(array('Ingrediente o Aditivo','Tipo','Funci�n','Cantidad'));
      ...
      //CAMBIO DE CONTENIDO NETO//  
       ...
       public function writeCmbCont($data){
        ...
        public function writeCmbRazFab($data){
             ...
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C','C'));
             $this->Row(array('Rif/Id','Raz�n Social Anterior','Raz�n Social Actual'));
        ...
        public function writeIncImp($data){
             ...
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C'));
             $this->Row(array('Rif','Raz�n Social del Importador'));
     ...
     //NUEVO CODIGO PARA ENVASE Y EMPAQUE
          public function writeProductoEE($arrProd){
           ...
           $this->SetFont('Arial','B','10');
           $this->SetAligns(array('C','C','C'));
           $this->Row(array('Producto','Denominaci�n','Uso'));
           $this->SetFont('Arial','','10');
           $this->SetAligns(array('L','L','L'));
          ...
          public function writeEnvaseEE($datEnvase){
               ...
               $this->SetFont('Arial','B','10');
               $this->SetAligns(array('C','C','C'));
               $this->Row(array('Descripci�n de la Materia','Nro.de Oficio Autorizado','Raz�n Social'));
               $this->SetFont('Arial','','10');
           ...
           public function writeEquipoF($datEq){
               $this->SetFont('Arial','B','10');
               $this->MultiCell('190',6,'DATOS DEL EQUIPO PARA LA FABRICACI�N DE ALIMENTOS',1,'L',false); 
               $this->SetWidths(array(95,95));
               $this->SetFont('Arial','B','10');
               $this->SetAligns(array('C','C'));
               $this->Row(array('Descripci�n','Uso del Equipo de Fabricaci�n'));
               $this->SetFont('Arial','','10');
          ...
          //cambio de razon social y de denominacuio
           ...
           //Datos de laComposicion del Producto 
             ...
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C'));
             $this->Row(array('Denominaci�n Anterior','Denominaci�n Actual'));
             $this->SetAligns(array('C','J','C','J'));
             $this->Row(array(utf8_decode($data['d_denomina_anterior']),utf8_decode($data['d_denomina_actual'])));
        }
        public function writeCambioRazoEE($data){
           //Datos de laComposicion del Producto 
             ...
             $this->SetFont('Arial','B','10');
             $this->SetAligns(array('C','C'));
             $this->Row(array('Raz�n Social Anterior','Raz�n Social Actual'));
             $this->SetAligns(array('C','J','C','J'));
      ...
      //***FOOTER**************************************************************
          ...
          function writeFooter(){
            ...
            $this->Ln(1);
            $ubic ='Centro Sim�n Bol�var, Edificio Sur, Ministerio del Poder Popular para la Salud, piso 3, oficina 313. El Silencio, Caracas-Venezuela.';
            $telf ='Telf: (0212) 4080474 Fax (0212) 4080505 P�gina web: http://sacs.mpps.gob.ve.';
