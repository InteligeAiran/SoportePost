          ...
          switch ($area) {
            case 1:
              switch ($this->arrDatos["id_tipo_solicitud"]) {
                case 1:
                  if ($this->impNR == true) {
                        $titulo = "INCLUSI�N DE IMPORTADOR";
                  }else{
                ...
                case 2:
                  switch ($this->arrDatos["id_categoria_solicitud"]) {
                    case 5:
                      $titulo = "AJUSTE DE GRADO ALCOH�LICO";
                    break;
                    case 6:
                      $titulo = "CAMBIO DE DENOMINACI�N DEL PRODUCTO";
                    break;
                    case 7:
                      $titulo = "CAMBIO DE F�RMULA DE INGREDIENTES SECUNDARIOS O ADITIVOS";
                    break;
                    case 8:
                    ...
                    break;
                    case 10:
                      $titulo = "CAMBIO DE NUEVA PRESENTACI�N DE CONTENIDO NETO";
                    break;
                    case 11:
                      $titulo = "CAMBIO DE PRESENTACI�N DE DISE�O DE R�TULO";
                    break;
                    case 12:
                      $titulo = "CAMBIO DE RAZ�N SOCIAL DEL IMPORTADOR";
                    break;
                    case 13:
                      $titulo = "CAMBIO DE RAZ�N SOCIAL DEL FABRICANTE";
                    break;
                    case 14:
                      $titulo = "CAMBIO DE RAZ�N SOCIAL DEL T�TULAR DEL REGISTRO SANITARIO";
                    break;
                    case 15:
                      $titulo = "CAMBIO DEL T�TULAR DEL REGISTRO SANITARIO";
                    break;
                    case 17:
                      $titulo = "CAMBIO DE LUGAR DE FABRICACI�N";
                    break;
                    case 19:
                      $titulo = "INCLUSI�N DE IMPORTADOR";
                    break;
                    case 20:
                      $titulo = "INCLUSI�N DE NUEVA PLANTA FABRICANTE";
                    break;
                    case 21:
                      $titulo = "INCLUSI�N DE NUEVA PLANTA ENVASADORA";
                    break;
                    case 22:
                      $titulo = "INCLUSI�N DE NUEVA PRESENTACI�N DE CONTENIDO NETO";
                    break;
                    case 23:
                      $titulo = "INCLUSI�N DE NUEVA PRESENTACI�N DE MATERIAL DE ENVASE";
                    break;
                    case 24:
                      $titulo = "INCLUSI�N DE NUEVA PRESENTACI�N EXCLUSIVA PARA EXPORTACI�N";
                    break;
                    case 25:
                      $titulo = "INCLUSI�N DE NUEVA PRESENTACI�N PROMOCIONAL";
                    break;
                    case 40:
                      $titulo = "INCLUSI�N DE NUEVA PRESENTACI�N PARA LICORES EN ZONA DE COMERCIALIZACI�N";
                    break;
                  }
                break;
                case 3:
                   $titulo = "RENOVACI�N DE REGISTRO SANITARIO DE PRODUCTO"; 
                break;
              }
              $tipoOrig = "";
              switch ($this->tipo) {
    ...
    //***TIPO DE SOLICITUD**********************************************************
     ...
     //***NUMERO DE REGISTRO******************************************************
      ...
      function writeNroRegistro(){
           ...
           $this->Ln(1);
           $this->cell(133);
           $this->Cell(55,5,"N�mero de Registro Sanitario",1,'L','C');
      ...
      function writeMarco($val){
            switch ($val) {
              case 'i':
                  ...
                  */
                  $marco= "El Servicio Aut�nomo de Controlar�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos seg�n Gaceta Oficial N� 25.864 de fecha 16 de enero de 1959, Art�culos del 30 al 38 y en las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Art�culos del 12 al 25, AUTORIZA el Registro Sanitario del:";
              break;
              case 'ii':
                   /*REGISTRO DE ALIMENTO  ARTESANAL
                  */
                  $marco= "El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos seg�n Gaceta Oficial N� 25.864 de fecha 16 de enero de 1959, Art�culos del 30 al 38 y en la Providencia Administrativo N� 165-2017 de fecha 21 de junio de 2017, mediante la cual se Establecen los Requisitos para las Solicitudes Realizadas por Todos Aquellos Productores(as) que Elaboran, Manipulan, Envasen, Distribuyan, Comercializan y Expendan Alimentos Artesanales, AUTORIZA  el Registro Sanitario del:
";
              break;
              case 'iii':
                  ...
                  */
                  $marco= "El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en la Ley Org�nica  de Salud seg�n  Gaceta Oficial N� 36.579 de fecha 11 de noviembre de 1998, Art�culos  32 y 33, en el Reglamento General de Alimentos Gaceta Oficial N� 25.864 de fecha 16 de enero de 1959, Art�culos del 30 al 38, en las Normas Complementarias del Reglamento General de Alimentos Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Art�culos del 12 al 25 y en el Reglamento de la Ley de Impuesto sobre Alcohol y Especies Alcoh�licas Gaceta Oficial N� 3.665 Extraordinario de fecha 05/12/1985, Art�culo 8, AUTORIZA el Registro Sanitario del: ";
              break;
              case 'iiii':
                   /*REGISTRO DE BEBIDA ALCOHOLICA ARTESANAL
                  */
                  $marco= "El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en la Ley Org�nica de Salud seg�n  Gaceta Oficial N� 36.579 de fecha 11 de noviembre de 1998, Art�culos 32 y 33, en el Reglamento General de Alimentos Gaceta Oficial N� 25.864 de fecha 16 de enero de 1959, Art�culos del 30 al 38, en las Normas Complementarias del Reglamento General de Alimentos Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Art�culos del 12 al 25, en el Reglamento de la Ley de Impuesto sobre Alcohol y Especies Alcoh�licas Gaceta Oficial N� 3.665 Extraordinario de fecha 05/12/1985, Art�culo 8, en el Decreto con Rango, Valor y Fuerza de Ley de Reforma de la Ley de Impuestos sobre Alcohol y Especies Alcoh�licas. Decreto N� 5.618 del 03/10/2007, publicada en Gaceta Oficial Extraordinario N� 5.852 de fecha 05 de octubre de 2007, Art�culo 3 y en la Providencia Administrativa N� 165-2017 de fecha 21 de junio de 2017,mediante la cual se Establecen los Requisitos para las Solicitudes Realizadas por Todos Aquellos Productores/as que Elaboran, Manipulen, Envasen, Distribuyan, Comercialicen y Expendan Alimentos Artesanales, AUTORIZA el Registro Sanitario del:";
             break;
              case 'renov_i':
                  /*  RENOVACI�N DE ALIMENTO NACIONAL
                      RENOVACI�N DE BEBIDA IMPORTADO
                  */
                  $marco= "El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Art�culo 22, AUTORIZA la Renovaci�n del Registro Sanitario del:";
              break;
              case 'renov_ii':
                  /*  
                  RENOVACI�N DE ALIMENTO NACIONAL ARTESANAL
                  RENOVACI�N DE BEBIDA NACIONAL ARTESANAL
                  */
                  $marco= "El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en la Providencia Administrativa N� 165-2017 de fecha 21 de junio de 2017, mediante la cual se Establecen los Requisitos para las Solicitudes Realizadas por Todos Aquellos Productores/as que Elaboran, Manipulen, Envasen, Distribuyan, Comercialicen y Expendan Alimentos Artesanales,AUTORIZA la Renovaci�n del Registro Sanitario del:";
              break;
              case 'inclusion':
                  /*  INCLUSION
                  */
                  ...
                  switch ($this->elab) {
                    ...
                    break;
                    default:
                          $marco.="El Servicio Aut�nomo de Contralor�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Art�culo 24 , ";
                    break;
                  } 
                  switch ($this->arrDatos["id_categoria_solicitud"]) {
                      case 2:
                      case 4:
                      case 19:
                        $marco.="AUTORIZA la Inclusi�n del Importador solicitado del Producto:";
                      break;
                      case 5:
                        $marco.="AUTORIZA el Ajuste del Grado Alcoh�lico del Producto:";
                      break;
                      case 6:
                        $marco.="AUTORIZA el Cambio de Denominaci�n solicitado del:";
                      break; 
                      case 7:
                        $marco.="AUTORIZA el Cambio de F�rmula solicitado del:";
                      break; 
                      case 8:
                      ...
                      break; 
                      case 10:
                        $marco.="AUTORIZA el Cambio de Nueva Presentaci�n de Contenido Neto solicitado del Producto:";
                      break;
                      case 11:
                        $marco.="AUTORIZA el Cambio de Presentaci�n de Dise�o del R�tulo solicitado del:";
                      break;
                      case 12:
                        $marco.="AUTORIZA el Cambio solicitado de Raz�n Social del Importador:";
                      break;
                      case 13:
                        $marco.="AUTORIZA el Cambio solicitado de Raz�n Social del Fabricante:";
                      break;  
                      case 14:
                        $marco.="AUTORIZA el Cambio solicitado de Raz�n Social del Titular del Registro Sanitario del Producto:";
                      break;
                      case 15:
                        $marco.="AUTORIZA el Cambio solicitado del Titular del Registro Sanitario:";
                      break;
                       case 17:
                        $marco.="AUTORIZA el Cambio solicitado del lugar de fabricaci�n del Registro Sanitario:";
                      break;
                      case 20:
                        $marco.="AUTORIZA la Inclusi�n de Nueva Planta Fabricante solicitada del Producto:";
                      break;
                      case 21:
                        $marco.="AUTORIZA la Inclusi�n de Nueva Planta Envasadora solicitada del Producto:";
                      break; 
                      case 22:
                        $marco.="AUTORIZA la Inclusi�n de Nueva Presentaci�n de Contenido Neto solicitado del Producto:";
                      break;
                      case 23:
                        $marco.="AUTORIZA la Inclusi�n de Nueva Presentaci�n de Material de Envase solicitado del Producto:";
                      break;   
                      case 24:
                        $marco.="AUTORIZA la Inclusi�n de Presentaci�n Exclusiva para Exportaci�n solicitada del Producto:";
                      break;   
                      case 25:
                        $marco.="AUTORIZA la Inclusi�n de Presentaci�n de Promocional solicitada del Producto:";
                      break;
                      case 40:
                        $marco.="AUTORIZA la Inclusi�n de Presentaci�n para Licores en Zona de Comercializaci�n:";
                      break;        
                  }
              break;
            }
      ...
      //***DATOS SOLICITUD**************************************************************
        ...
        private function denom(){
          $denom = $this->Row(array('DENOMINACI�N',strtoupper(utf8_decode($this->arrDetProd['d_denomina']))));
        ...
        private function lugarFab(){
          $lugarFab = $this->Row(array('LUGAR DE FABRICACI�N',utf8_decode($this->arrPlant)));
          return $lugarFab;
        }
        ...
        public function writeAjusteGrado($data){  
             ...
             $this->Row(array('GRADO ANTERIOR','GRADO SOLICITADO','DENOMINACI�N DESPUES DEL CAMBIO'));
        ...
        public function writeCmbDeno($data){
            $this->Ln(2);
             //Datos de la Composicion del Producto 
             $this->SetFont('Arial','B','9');
             $this->MultiCell('190',6,'INFORMACI�N DEL CAMBIO SOLICITADO',1,'C',false); 
             $this->SetWidths(array(90,100));
             $this->SetFont('Arial','B','9');
             $this->SetAligns(array('C','C'));
             if ($data['d_tipo_denomina'] == 1) {
                $this->Row(array('DENOMINACI�N ANTERIOR','DENOMINACI�N SOLICITADA'));
             ...
             if ($data['d_tipo_denomina'] == 2) { 
                $this->Row(array('NOMBRE DE FANTAS�A ANTERIOR','NOMBRE DE FANTAS�A SOLICITADO'));
                $this->SetAligns(array('J','J'));
        ...
        public function writeCmbIngre($data){
           ...
           //Datos de la Composicion del Producto 
             ...
             $this->Row(array('INGREDIENTE O ADITIVO','TIPO','FUNCI�N','CANTIDAD'));
        ...
        public function writeCmbRazImp($data){
             ...
             $this->SetFont('Arial','B','9');
             $this->SetAligns(array('C','C','C'));
             $this->Row(array('RIF','RAZ�N SOCIAL ANTERIOR','RAZ�N SOCIAL ACTUAL'));
             $this->SetAligns(array('C','C','J'));
        ...
        public function writeCmbRazFab($data){  
             ...
             if ($data['tipo_empresa'] == 1) {
              ...
              $this->Row(array('ID','RAZ�N SOCIAL ANTERIOR','RAZ�N SOCIAL ACTUAL'));
             }
        ...
        public function writeIncImp($data){
             ...
             //Datos de la Composicion del Producto 
             $this->SetFont('Arial','B','9');
             $this->MultiCell('190',6,'DATOS DE LA INCLUSI�N SOLICITADA',1,'C',false); 
        ...
        public function writeIncFab($data){
             ...
             switch ($data['tipo']) {
                case 1:
                  ...
                  $this->SetFont('Arial','B','9');
                  $this->SetAligns(array('C','C'));
                  $this->Row(array('PERMISO SANITARIO','UBICACI�N DE LA PLANTA'));
                  $this->SetAligns(array('C','J'));
        ...
        public function writeIncCont($data){
         ...
         public function writeIncMat($data){
             ...
             $this->SetFont('Arial','B','9');
             $this->SetAligns(array('C','C'));
             $this->Row(array('NRO. AUTORIZACI�N','ENVASE'));
             $this->SetAligns(array('C','J'));
        ...
        public function writeIncExp($data){
            ...
            //Datos de la Composicion del Producto 
             ...
             $this->SetFont('Arial','B','9');
             $this->SetAligns(array('C','C','C','C'));
             $this->Row(array('DENOMINACI�N PARA EXPORTACI�N','CONT. NETO','UNIDAD MEDIDA','PAIS'));
        ...
        public function writeIncPromo($data){
            ...
            //Datos de la Composicion del Producto 
             ...
             $this->SetFont('Arial','B','9');
             $this->SetAligns(array('C','C','C'));
             $this->Row(array('NOMBRE DE PROMOCI�N','CONT. NETO','UNIDAD MEDIDA'));
        ...
        /*INCLUSION DE PRESENTACION PARA LICORES 
          ...
          public function writeIncLiZona($data){
            ...
            //Datos de la Composicion del Producto 
             ...
             $this->Row(array('ZONA DE COMERCIALIZACI�N:',$data));
             $this->SetAligns(array('J','J'));
              /*
             for($j=0;$j<count($data);$j++){
             $this->Row(array(utf8_decode($data[$j]['d_nombre_prod']),utf8_decode($data[$j]['n_contenido_neto']),utf8_decode($data[$j]['simbolo']),utf8_decode(strtoupper($data[$j]['d_pais']))));
        ...
        public function writeZonas($data){
            ...
            //Datos de la Composicion del Producto 
             $this->SetFont('Arial','B','9');
             $this->MultiCell('190',6,'DATOS DE LAS ZONAS DE COMERCIALIZACI�N',1,'C',false); 
            ...
            switch ($area) {
              case 1:
                switch ($this->arrDatos["id_categoria_solicitud"]) {
                  ...
                  case 4:
                    if ($this->impNR) {
                      $aprob1= "El referido producto se encuentra autorizado bajo el N�mero de Registro indicado al comienzo de este documento. Asimismo, este Servicio Aut�nomo cumple con notificarle que una vez verificada la documentaci�n anexa, se pudo constatar que la misma se ajusta a la normativa sanitaria vigente, en consecuencia este Despacho le concede lo solicitado.";
                      $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                    }else{
                      $aprob1= "El referido producto se encuentra autorizado bajo el N�mero de Registro indicado al comienzo de este documento, por lo que su Libre Venta y Consumo, est� permitida en todo el Territorio de la Rep�blica Bolivariana de Venezuela, someti�ndose a las regulaciones relativas a Vigilancia y Control, Publicidad, Promoci�n y dem�s prescripciones establecidas en la normativa vigente para este tipo de producto.";
                      $aprob2= "Este registro tendr� una vigencia de ".$arrAprob['total']." a partir de la fecha de emisi�n de este documento. Por consiguiente, a su vencimiento deber� renovarse de acuerdo a lo establecido en el art�culo 22 de las referidas Normas Complementarias.";
                      $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                    }
                  break;
                  case 19:
                  ...
                  case 24:
                  case 25:
                    $aprob1= "El referido producto se encuentra autorizado bajo el N�mero de Registro indicado al comienzo de este documento. Asimismo, este Servicio Aut�nomo se reserva el derecho de realizar inspecciones y/o solicitar cualquier documentaci�n que considere pertinente a los fines de verificar la informaci�n suministrada.";
                    $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                  break;
                  case 32:
                  case 33:
                  ...
                  case 35:
                  case 40:
                    $aprob1= "El referido producto se encuentra autorizado bajo el N�mero de Registro indicado al comienzo de este documento. Asimismo, este Servicio Aut�nomo se da por notificado y se reserva el derecho de realizar inspecciones y/o solicitar cualquier documentaci�n que considere pertinente a los fines de verificar la informaci�n suministrada.";
                    $aprob2= "Esta Autorizaci�n tendr� una vigencia de ".$arrAprob['total']." a partir de la fecha de emisi�n de este documento. Por consiguiente, a su vencimiento deber� renovarse nuevamente de acuerdo a lo establecido en el Art�culo 22 de las referidas Normas Complementarias ";
                    $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                  break;
                  ...
                  case 51;
                  case 52;
                    $aprob1= "De igual forma se le participa que dicha autorizaci�n est� sujeta a las revisiones de este Despacho estime oportuno realizar de acuerdo a los avances de la Ciencia y Tecnolog�a en resguardo de la salud p�blica.";
                    $aprob2= "Esta autorizaci�n tiene una vigencia de cinco (5) a�os contados a partir de la presente fecha.";
                    $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                  break;
      ...
      //***FIRMA ELECTRONICA**************************************************************
        ...
        function writeFirma($ced){
           ...
           // $this->MultiCell('190','6',$this->firma,'0','J',false);
            ///$firmado = 'Este documento est� Firmado Digitalmente por el Director(a) General del Servicio Aut�nomo de Contralor�a Sanitaria: , bajo los est�ndares de seguridad del SACS. Para verificar la valid�z de este registro puede ingresar a la p�gina Web http://www.sacs.gob.ve, secci�n "CONSULTAS" y seleccionar "Alimentos y Bebidas Alcoh�licas".';
      ...
      //***FOOTER**************************************************************
          ...
          function writeFooter(){
            ...
            $servicio ='Servicio Aut�nomo de Contralor�a Sanitaria.';
            $direccion ='Direcci�n de Inocuidad de Alimentos y Bebidas.';
            $this->Ln(3);
 ...
 //NUEVOS METODOS ESPECIFICOS PARA ENVASE EMPAQUE
  ...
  function writeTipSolEnvase($tipo){
              ...
              switch ($tipo) {
                    ...
                    case 45:
                    $titulo = "RENOVACI�N DE ENVASE, EMPAQUE O ARTICULO NACIONAL";
                    break;
                    case 46;
                    $titulo = "RENOVACI�N DE MATERIA PRIMA NACIONAL";
                    break;
                    case 47;
                    $titulo = "RENOVACI�N DE DETERGENTE O DESINFECTANTE NACIONAL";
                    break;
                    case 48;
                    $titulo = "RENOVACI�N DE EQUIPOS DE FABRICACION DE ALIMENTO NACIONAL";
                    break;
                    ...
                    case 53:
                    $titulo = "RENOVACI�N DE ENVASE, EMPAQUE O ARTICULO IMPORTADA";
                    break;
                    case 54;
                    $titulo = "RENOVACI�N DE MATERIA PRIMA IMPORTADA";
                    break;
                    case 55;
                    $titulo = "RENOVACI�N DE DETERGENTE O DESINFECTANTE IMPORTADA";
                    break;
                    case 56;
                    $titulo = "RENOVACI�N DE EQUIPOS DE FABRICACION DE ALIMENTO IMPORTADA";
                    break;

                    //CAMBIOS

                    case 57;
                    $titulo = "CAMBIOS DE DENOMINACI�N DE MATERIAS PRIMAS, ENVASES Y/O EMPAQUES";
                    break;                    
                    case 58;
                    $titulo = "CAMBIO DE RAZ�N SOCIAL EN EL REGISTRO DE MATERIAS PRIMAS, EMPAQUES Y/O ENVASES";
                    break;
                  }
...
//***DATOS SOLICITUD**************************************************************
        ...
        private function compo($compo){
          $denom = $this->Row(array('COMPOSICI�N',strtoupper(utf8_decode($compo))));
          return $clase;
        }
        ...
        private function deno_comer($arrDetProd){
          $denom = $this->Row(array('DENOMINACI�N COMERCIAL',strtoupper(utf8_decode($arrDetProd["d_denomina"]))));
          return $clase;
        }
        ...
        private function lugarFab1($Datos){
          $lugarFab = $this->Row(array('LUGAR DE FABRICACI�N',utf8_decode($Datos['d_ciudad'].'- '.$Datos['d_estado'])));
          return $lugarFab;
        }
        ...
        private function lugarFab2($Datos){
          $lugarFab = $this->Row(array('LUGAR DE FABRICACI�N',utf8_decode(strtoupper($Datos['d_pais']).' - '.$Datos['d_ciudad'])));
          return $lugarFab;
        }
 ...
 //***MARCO LEGAL***************************************************************
  ...
  switch ($Tipo) {
         ...
         case 49:
         case 53:
        $marco= "El Servicio Aut�nomo de Controlar�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos Resoluci�n N� SG-081 de fecha 11/03/1996. Seg�n Gaceta Oficial N� 25.864 de fecha 16 de enero de 1959, Y las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996:";
          //  Marco legal i (1)
          $this->SetFont('Arial','','10');
          $this->Ln(8);
          $this->MultiCell('190','5',$marco,'0','J',false);
         ...
         case 50: 
         case 54:
         $marco= "El Servicio Aut�nomo de Controlar�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos Resoluci�n N� SG-081 de fecha 11/03/1996. Seg�n Gaceta Oficial N� 25.864 decreto N� 525-12 de fecha 16 de enero de 1959, Y las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996:";
          //  Marco legal i (1)
          $this->SetFont('Arial','','10');
          $this->Ln(8);
          $this->MultiCell('190','5',$marco,'0','J',false);
         ...
         case 51:
         case 55:
         $marco= "El Servicio Aut�nomo de Controlar�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos. Normas Buenas pr�cticas Resoluci�n N� SG-457-96 de fecha 11/03/1996. Seg�n Gaceta Oficial N� 25.864 decreto N� 525-12 de fecha 16 de enero de 1959, Y las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 36.081 de fecha 07 de noviembre de 1996, Normas Sanitarias para el registro y control de producto de Aseo, Desinfecci�n, Mantenimiento y Ambientadores de Usos Dom�stico e Industriales Resoluci�n N� 258 gaceta oficial N� 37.973 del 06 de Julio de 2004:";
          //  Marco legal i (1)
          $this->SetFont('Arial','','10');
          $this->Ln(8);
          $this->MultiCell('190','5',$marco,'0','J',false);
         ...
         case 57:
         case 58:
         $marco= "El Servicio Aut�nomo de Controlar�a Sanitaria (SACS), ente adscrito al Ministerio del Poder Popular para la Salud, de conformidad con lo establecido en el Reglamento General de Alimentos Resoluci�n N� SG-081 de fecha 11/03/1996. Seg�n Gaceta Oficial N� 35.921 de fecha 15 de marzo de 1996, Y las Normas Complementarias del Reglamento General de Alimentos seg�n Gaceta Oficial N� 36.081 de fecha 07 de noviembre de 1996:";
          //  Marco legal i (1)
          $this->SetFont('Arial','','10');
          $this->Ln(8);
          $this->MultiCell('190','5',$marco,'0','J',false);
            ...
            switch ($area) {
              case 1:
                switch ($this->arrDatos["id_categoria_solicitud"]) {
                  ...
                  case 51;
                  case 52;
                    $aprob1= "De igual forma se le participa que dicha autorizaci�n est� sujeta a las revisiones de este Despacho estime oportuno realizar de acuerdo a los avances de la Ciencia y Tecnolog�a en reguardo de la salud p�blica.";
                    $aprob2= "Esta Autorizaci�n tendr� una vigencia de ".$arrAprob['total']." a partir de la fecha de emisi�n de este documento. Por consiguiente, a su vencimiento deber� renovarse nuevamente de acuerdo a lo establecido en el Art�culo 22 de las referidas Normas Complementarias ";
                    $aprob3= "Autorizaci�n que se expide a petici�n de la parte interesada, en la ciudad Caracas a los ".$arrAprob['dia']." dias del mes de ".$arrAprob['mes']." del a�o ".$arrAprob['ano'];
                  break;
