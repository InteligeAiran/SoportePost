...
class xajax
{
	...
	function _wrap($sFunction,$sRequestType=XAJAX_POST)
	{
		$js = "function ".$this->sWrapperPrefix."$sFunction(){ 
				...
				document.getElementById('block').innerHTML = \"<img src='http://sacs.mpps.gob.ve:8082/imagen/institucional/loading.gif' />\"; 
	...
	//'position: absolute;top:50%; left:50%; width:400px; margin-left:-200px; height:300px; margin-top:-150px; border:1px solid #808080; padding:5px;'; 

	/**
	 * Takes a string containing xajax xjxobj XML or xjxquery XML and builds
