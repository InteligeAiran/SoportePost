        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" id="tecnico" href="tecnico">
                    ...
                    <span class="nav-link-text ms-3">Gestión Técnicos</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="taller" href="taller">
                    ...
                    <span class="nav-link-text ms-3">Gestión Taller</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pendiente_entrega" href="pendiente_entrega">
                    ...
                    <span class="nav-link-text ms-3">Pendiente por Entrega</span>
                </a>
            </li>
