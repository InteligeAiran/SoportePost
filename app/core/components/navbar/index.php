                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="crearTicketDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="estadisticas-link" href="../pages/profile.html">
                            ...
                            <span class="nav-link-text ms-3">Gestión de Usuarios</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="cerrar-link" href="cerrar_session">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M6 12.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-8a.5.5 0 0 0-.5.5v2a.5.5 0 0 1-1 0v-2A1.5 1.5 0 0 1 6.5 2h8A1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 0 0 1 5 12.5v-2a.5.5 0 0 1 1 0z"/>
